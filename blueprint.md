...
1.  **Core Identification:** Implemented using Teachable Machine.
2.  **Encyclopedia:** Functional with search and detailed group/member views.
3.  **Multilingual:** Implemented and integrated across all components.
4.  **Aesthetic:** Modern neon-dark theme fully applied.
